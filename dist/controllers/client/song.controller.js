...
const favorite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (typeFavorite) {
        case "favorite":
            const existFavortieSong = yield favorite_songs_model_1.default.findOne({
                songId: idSong,
            });
            if (!existFavortieSong) {
                yield favorite_songs_model_1.default.create({
                    songId: idSong,
                    userId: ""
                });
            }
            break;
        case "unfavorite":
            yield favorite_songs_model_1.default.findOneAndDelete({
                songId: idSong
            });
            break;
        default:
